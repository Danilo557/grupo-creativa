<x-store-layout>
    <div class="container py-12 mx-auto">
        <section class="grid xl:grid-cols-5 lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-6 text-white">
            <a href="{{route('orders.index'). "?status=1"}}" class="bg-red-600 bg-opacity-75 rounded-lg px-12 pt-8 pb-4">
                <p class="text-center text-2xl">
                    {{ $pendiente }}
                </p>
                <p class="text-center uppercase">Pendiente</p>
                <p class="text-center uppercase text-2xl mt-2">
                    <i class="fas fa-business-time"></i>
                </p>
            </a>
            <a href="{{route('orders.index'). "?status=2"}}" class="bg-gray-600 bg-opacity-75 rounded-lg px-12 pt-8 pb-4">
                <p class="text-center text-2xl">
                    {{ $recibido }}
                </p>
            ...
            <a href="{{route('orders.index'). "?status=3"}}" class="bg-yellow-600 bg-opacity-75 rounded-lg px-12 pt-8 pb-4">
                <p class="text-center text-2xl">
                    {{ $enviado }}
                </p>
            ...
            <a href="{{route('orders.index'). "?status=5"}}" class="bg-green-600 bg-opacity-75 rounded-lg px-12 pt-8 pb-4">
                <p class="text-center text-2xl">
                    {{ $anulado }}
                </p>
