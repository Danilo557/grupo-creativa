<x-store-layout>
    @push('css')
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/flexslider/2.7.2/flexslider.min.css"
            integrity="sha512-c7jR/kCnu09ZrAKsWXsI/x9HCO9kkpHw4Ftqhofqs+I2hNxalK5RGwo/IAhW3iqCHIw55wBSSCFlm8JP0sw2Zw==" crossorigin="anonymous"
            ...
            @foreach ($brand->products as $product)
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-24">
                    ...
                    <div>
                        ...
                        <a class="boton-add w-full text-center">
                            <span class="font-bold text-lg">Agregar</span>
                        </a>
